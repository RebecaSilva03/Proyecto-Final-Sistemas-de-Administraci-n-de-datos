...
CREATE TABLE asistencia (
    ...
    empleado_id INT,
	asi_hora_entrada DATETIME NOT NULL,
    asi_hora_salida DATETIME NOT NULL,
...
CREATE TABLE envios (
    ...
    CONSTRAINT fk_detalle_pedido FOREIGN KEY (detalle_id) REFERENCES detalle_pedido(detalle_id),
    CONSTRAINT fk_direcciones_1 FOREIGN KEY (direcciones_id) REFERENCES direcciones(direcciones_id)
);
